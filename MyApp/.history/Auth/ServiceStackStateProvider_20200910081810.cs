...
namespace MyApp
{
    public class ServiceStackStateProvider : AuthenticationStateProvider
    {
        ...
        private AddProtectedBrowserStorage ProtectedLocalStorage { get; set; }

        public ServiceStackStateProvider(JsonHttpClient client, ProtectedLocalStorage localStorage)
        {
            this.client = client;
            this.ProtectedLocalStorage = localStorage;
        }
